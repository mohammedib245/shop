 ...
 <div class="page-sidebar">
    <div class="main-header-left d-none d-lg-block">
        <div class="logo-wrapper">
            <a href="index.html">
                <img class="d-none d-lg-block blur-up lazyloaded" src="{{ asset('assets/dashboard/') }}assets/images/dashboard/multikart-logo.png"
                    alt="">
            </a>
        </div>
    </div>
    <div class="sidebar custom-scrollbar">
        ...
        <div class="sidebar-user">
            <img class="img-60" src="{{ asset('assets/dashboard') }}/assets/images/dashboard/user3.jpg" alt="#">
            <div>
                <h6 class="f-14">{{ Auth::user()->name ?? 'JOHN' }}</h6>
                <p>general manager.</p>
            </div>
        </div>
        <ul class="sidebar-menu">
            ...
            <li>
                <a class="sidebar-header" href="javascript:void(0)">
                    ...
                    <span>{{ trans('dashboard.categories') }}</span>
            ...
            {{-- categories --}}
             ...
             <li>
                <a class="sidebar-header" href="javascript:void(0)">
                    <i data-feather="box"></i>
                    <span>{{ trans('dashboard.products') }}</span>
                    <i class="fa fa-angle-right pull-right"></i>
                </a>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="product-review.html">
                            <i class="fa fa-circle"></i>
                            <span>{{ trans('dashboard.products_list') }}</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="order-list.html">
                            <i class="fa fa-circle"></i>
                            <span>{{ trans('dashboard.orders_list') }}</span>
                        </a>
                    </li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('users.index') }}">
                            <i class="fa fa-circle"></i>{{ trans('dashboard.users') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('users.create') }}">
                            <i class="fa fa-circle"></i>{{ trans('dashboard.user_create') }}
                        </a>
                    </li>
                </ul>
            </li>
              ...
              {{-- settings --}}
              <li>
                <a class="sidebar-header" href=""><i data-feather="settings"></i><span>{{ trans('dashboard.site_settings') }}</span></a>
            </li>
              {{-- settings --}}
                    ...
                    <ul class="list">
                        <li class="clearfix">
                            <img class="rounded-circle user-image blur-up lazyloaded"
                                src="{{ asset('assets/dashboard/') }}assets/images/dashboard/user.jpg" alt="">
