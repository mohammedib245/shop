...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/dashboard') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('assets/dashboard') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard')}}/assets/css/vendors/flag-icon.css">

    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard')}}/assets/css/vendors/icofont.css">

    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard')}}/assets/css/vendors/prism.css">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/dashboard')}}/assets/css/vendors/chartist.css">
...
<body class="rtl">
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                    src="{{asset('assets/dashboard')}}/assets/images/dashboard/user3.jpg" alt="header-user">
    ...
    <!-- Bootstrap js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/bootstrap.bundle.min.js"></script>
    ...
    <!--chartist js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/chart/chartist/chartist.js"></script>

    <!--chartjs js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/chart/chartjs/chart.min.js"></script>

    <!-- lazyload js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/lazysizes.min.js"></script>

    <!--copycode js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/prism/prism.min.js"></script>
    <script src="{{asset('assets/dashboard')}}/assets/js/clipboard/clipboard.min.js"></script>
    <script src="{{asset('assets/dashboard')}}/assets/js/custom-card/custom-card.js"></script>
    ...
    <script src="{{asset('assets/dashboard')}}/assets/js/counter/counter-custom.js"></script>

    <!--peity chart js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/chart/peity-chart/peity.jquery.js"></script>

    <!-- Apex Chart Js -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>

    <!--sparkline chart js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/chart/sparkline/sparkline.js"></script>

    <!--Customizer admin-->
    {{-- <script src="{{asset('assets/dashboard')}}/assets/js/admin-customizer.js"></script> --}}

    <!--dashboard custom js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/dashboard/default.js"></script>

    <!--right sidebar js-->
    <script src="{{asset('assets/dashboard')}}/assets/js/chat-menu.js"></script>
